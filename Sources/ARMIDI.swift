...
public func findObject(withUniqueID uniqueID: MIDIUniqueID) throws -> (object: any ObjectReferable, type: MIDIObjectType) {
...
public func device(atIndex index: Int) -> any DeviceReferable {
...
public func devices() -> [any DeviceReferable] {
...
public func createClient(name: String, notificationHandler: ClientNotificationHandler?) throws -> any ClientReferable {
